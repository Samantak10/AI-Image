    ...
    <section className="max-w-7xl mx-auto">
      <div>
        <h1 className='font-extrabold text-[#222328]
         ...
         max-w [500px]'>Create imaginative and visually stunning images through AI and share them with the community</p>
      </div>
      ...
      <form className="mt-16 max-w-3xl" onSubmit={handleSubmit}>
        ...
        <div className='mt-10'>
          ...
          you have created the image you want, you can share it 
